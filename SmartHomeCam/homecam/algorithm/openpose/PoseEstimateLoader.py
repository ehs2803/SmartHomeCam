...
from homecam.algorithm.openpose.SPPE.src.main_fast_inference import InferenNet_fast, InferenNet_fastRes50
from homecam.algorithm.openpose.SPPE.src.utils.eval import getPrediction
from homecam.algorithm.openpose.SPPE.src.utils.img import crop_dets
from homecam.algorithm.openpose.pPose_nms import pose_nms
