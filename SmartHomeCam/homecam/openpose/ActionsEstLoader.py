...
from homecam.algorithm.openpose.Actionsrecognition.Models import TwoStreamSpatialTemporalGraph
from homecam.algorithm.openpose.pose_utils import normalize_points_with_size, scale_pose
...
class TSSTG(object):
    ...
    """
    def __init__(self,
                 weight_file='homecam/algorithm/openpose/Models/TSSTG/tsstg-model.pth',
                 device='cuda'):
